        ...
        <div className="grid gap-8 lg:grid-cols-4 md:grid-cols-2">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <div className="h-8 w-8 rounded-lg bg-primary flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 text-primary-foreground">
                  <path d="M12 3a9 9 0 1 0 9 9h-2a7 7 0 1 1-7-7Z"/>
                </svg>
              </div>
              <span className="font-semibold text-foreground">ALX Polly</span>
            </div>
            <p className="text-muted-foreground mb-4 max-w-md">
              Create polls, vote, and share results. Make decisions faster with our simple polling platform.
            </p>
          ...
          <div>
            ...
            <nav className="grid gap-3">
              <Link href="/polls" className="text-muted-foreground hover:text-foreground transition-colors">Browse polls</Link>
              <Link href="/polls/new" className="text-muted-foreground hover:text-foreground transition-colors">Create poll</Link>
